namespace TestScaffolderExtension.CreateUnitTestsForMethodCommand.TemplateProcessing
{
    ...
    using TestScaffolderExtension.CreateUnitTestsForMethodCommand.Models.Analysis;
    using static TestScaffolderExtension.CreateUnitTestsForMethodCommand.MethodUnderTestAnalyzer;

    public class UnitTestCreationDetails
    {
        ...
        public Project ProjectUnderTest { get; private set; }

        public Project RecommendedUnitTestProject { get; internal set; }
        ...
        public string UnitTestDesiredPathFromProject { get; private set; }

        public string UnitTestFolderName { get; private set; }

        private void CalculateUnitTestCreationDetails(MethodDeclarationSyntax method, SemanticModel semanticModel)
        {
